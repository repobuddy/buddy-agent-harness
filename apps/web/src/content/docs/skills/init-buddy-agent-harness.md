---
title: 'Skill: init-buddy-agent-harness'
description: What the init-buddy-agent-harness skill does, what it asks you to approve, and what it leaves alone.
---
...
The run ends by asking whether to run [`enhance`](/skills/enhance/), which offers guidance your `AGENTS.md` does not have. Decline and nothing more happens. That offer is the only opinion the skill carries, and even it is a question.
