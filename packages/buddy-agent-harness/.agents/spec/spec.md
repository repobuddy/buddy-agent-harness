...
| [`skills/enhance/`](./skills/enhance/README.md) | Which vetted sections the `enhance` skill offers, and when it offers a current wording in place of an earlier one |
