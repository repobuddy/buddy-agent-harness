...
# init-buddy-agent-harness

## What

The `init-buddy-agent-harness` **skill**'s conduct: what it consolidates, what it declines to invent, and which of its writes need a person's word first.
