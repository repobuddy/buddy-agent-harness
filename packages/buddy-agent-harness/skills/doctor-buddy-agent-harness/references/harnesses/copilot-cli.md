...
What to generate for it, what to leave alone, and which claims are contested: `../../../init-buddy-agent-harness/references/harnesses/copilot-cli.md`. That page is hand-written and is the one to read before writing anything for this harness.
