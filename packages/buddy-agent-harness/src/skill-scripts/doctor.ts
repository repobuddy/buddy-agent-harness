...
// Bundled into every shipped skill's scripts/doctor.mjs by scripts/generate-skills.ts (via `pnpm
// build`). The bundle is what ships inside the skill folder — nothing here reaches outside it at
// runtime.
//
